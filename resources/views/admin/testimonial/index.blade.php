            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="{{route('admin.testimonial.create')}}" id="sample_editable_1_new" class="btn sbold green"> اضافة
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                    ...
                    <tbody>
                        ...
                        <td>{{$loop->iteration}}</td>
                            ...
                            <td>
                                <a href="{{route('admin.testimonial.edit',$item->id)}}" id="sample_editable_1_new" class="btn sbold yellow"> تعديل
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a class="btn btn-danger btn-ok" href="{{route('admin.testimonial.delete',$item->id)}}">حذف</a>
                                    </div>
                                </div>
                            </div>
                        </div>
