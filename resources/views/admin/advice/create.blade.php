    ...
    <div class="portlet light ">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-dark sbold uppercase"> النصائح</span>
            </div>
        </div>
        <div class="portlet-body form">
            <form class="form-horizontal" role="form" method="POST" action="{{route('admin.advice.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">صورة خارجية</label>
                        <div class="col-md-9">
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <a href="{{route('admin.advice')}}" class="btn default">الغاء</a>
                        </div>
                    </div>
                </div>
            </form>
