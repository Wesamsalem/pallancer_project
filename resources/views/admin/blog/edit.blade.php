...
<div class="row">
    ...
    <div class="portlet light ">
        ...
        <div class="portlet-body form">
            <form class="form-horizontal" role="form" method="POST" action="{{route('admin.blog.update',$item->id)}}" enctype="multipart/form-data">
                @csrf
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea name="short_content" class="form-control" placeholder="نص مختصر">{{$item->short_content}}</textarea>                        </div>
                    </div>
                </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">فيديو</label>
                        <div class="col-md-9">
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <a href="{{route('admin.blog')}}" class="btn default">الغاء</a>
                        </div>
                    </div>
                </div>
            </form>
