...
<div class="row">
    ...
    <div class="portlet light ">
        ...
        <div class="portlet-body form">
            <form class="form-horizontal" role="form" method="POST" action="{{route('admin.aboutus.update',$item->id)}}" enctype="multipart/form-data">
                @csrf
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <select name="tec" class="form-control">
                                <option value="0" @if($item->tec == 0) selected @endif>من نحن</option>
                                <option value="1" @if($item->tec == 1) selected @endif>الاستثمار بالتكنولوجيا </option>
                            </select>
                        </div>
                    </div>
